...
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,PATTERN=new RegExp("(立(?:刻|即)|即刻)|(今|明|前|大前|后|大后|昨)(早|晚)|(上(?:午)|早(?:上)|下(?:午)|晚(?:上)|夜(?:晚)?|中(?:午)|凌(?:晨))|(今|明|前|大前|后|大后|昨)(?:日|天)(?:[\\s|,|，]*)(?:(上(?:午)|早(?:上)|下(?:午)|晚(?:上)|夜(?:晚)?|中(?:午)|凌(?:晨)))?","i"),NOW_GROUP=1,DAY_GROUP_1=2,TIME_GROUP_1=3,TIME_GROUP_2=4,DAY_GROUP_3=5,TIME_GROUP_3=6;exports.Parser=function(){Parser.apply(this,arguments),this.pattern=function(){return PATTERN},this.extract=function(r,a,t,e){r=t[0];var i=t.index,s=new ParsedResult({index:i,text:r,ref:a}),d=moment(a),m=d.clone();if(t[NOW_GROUP])s.start.imply("hour",d.hour()),s.start.imply("minute",d.minute()),s.start.imply("second",d.second()),s.start.imply("millisecond",d.millisecond());else if(t[DAY_GROUP_1]){var y=t[DAY_GROUP_1],l=t[TIME_GROUP_1];"明"==y?d.hour()>1&&m.add(1,"day"):"昨"==y?m.add(-1,"day"):"前"==y?m.add(-2,"day"):"大前"==y?m.add(-3,"day"):"后"==y?m.add(2,"day"):"大后"==y&&m.add(3,"day"),"早"==l?s.start.imply("hour",6):"晚"==l&&(s.start.imply("hour",22),s.start.imply("meridiem",1))}else if(t[TIME_GROUP_2]){var u=t[TIME_GROUP_2],o=u[0];"早"==o||"上"==o?s.start.imply("hour",6):"下"==o?(s.start.imply("hour",15),s.start.imply("meridiem",1)):"中"==o?(s.start.imply("hour",12),s.start.imply("meridiem",1)):"夜"==o||"晚"==o?(s.start.imply("hour",22),s.start.imply("meridiem",1)):"凌"==o&&s.start.imply("hour",0)}else if(t[DAY_GROUP_3]){var n=t[DAY_GROUP_3];"明"==n?d.hour()>1&&m.add(1,"day"):"昨"==n?m.add(-1,"day"):"前"==n?m.add(-2,"day"):"大前"==n?m.add(-3,"day"):"后"==n?m.add(2,"day"):"大后"==n&&m.add(3,"day");var p=t[TIME_GROUP_3];if(p){var _=p[0];"早"==_||"上"==_?s.start.imply("hour",6):"下"==_?(s.start.imply("hour",15),s.start.imply("meridiem",1)):"中"==_?(s.start.imply("hour",12),s.start.imply("meridiem",1)):"夜"==_||"晚"==_?(s.start.imply("hour",22),s.start.imply("meridiem",1)):"凌"==_&&s.start.imply("hour",0)}}return s.start.assign("day",m.date()),s.start.assign("month",m.month()+1),s.start.assign("year",m.year()),s.tags.ZHHansCasualDateParser=!0,s}};
},{"../../result":70,"../parser":55,"moment":2}],46:[function(require,module,exports){
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,util=require("../../utils/ZH-Hans.js"),PATTERN=new RegExp("(\\d{2,4}|["+Object.keys(util.NUMBER).join("")+"]{2,4})?(?:\\s*)(?:年)?(?:[\\s|,|，]*)(\\d{1,2}|["+Object.keys(util.NUMBER).join("")+"]{1,2})(?:\\s*)(?:月)(?:\\s*)(\\d{1,2}|["+Object.keys(util.NUMBER).join("")+"]{1,2})?(?:\\s*)(?:日|号)?"),YEAR_GROUP=1,MONTH_GROUP=2,DAY_GROUP=3;exports.Parser=function(){Parser.apply(this,arguments),this.pattern=function(){return PATTERN},this.extract=function(e,r,t,s){var a=moment(r),i=new ParsedResult({text:t[0],index:t.index,ref:r}),n=parseInt(t[MONTH_GROUP]);if(isNaN(n)&&(n=util.zhStringToNumber(t[MONTH_GROUP])),i.start.assign("month",n),t[DAY_GROUP]){var R=parseInt(t[DAY_GROUP]);isNaN(R)&&(R=util.zhStringToNumber(t[DAY_GROUP])),i.start.assign("day",R)}else i.start.imply("day",a.date());if(t[YEAR_GROUP]){var u=parseInt(t[YEAR_GROUP]);isNaN(u)&&(u=util.zhStringToYear(t[YEAR_GROUP])),i.start.assign("year",u)}else i.start.imply("year",a.year());return i.tags.ZHHansDateParser=!0,i}};
},{"../../result":70,"../../utils/ZH-Hans.js":76,"../parser":55,"moment":2}],47:[function(require,module,exports){
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,util=require("../../utils/ZH-Hans.js"),PATTERN=new RegExp("(\\d+|["+Object.keys(util.NUMBER).join("")+"]+|半|几)(?:\\s*)(?:个)?(秒(?:钟)?|分钟|小时|日|天|星期|礼拜|月|年|周)(?:(?:之|过)?后|(?:之)?内)","i"),NUMBER_GROUP=1,UNIT_GROUP=2;exports.Parser=function(){Parser.apply(this,arguments),this.pattern=function(){return PATTERN},this.extract=function(t,r,e,a){var s=e.index;t=e[0];var n=new ParsedResult({index:s,text:t,ref:r}),i=parseInt(e[NUMBER_GROUP]);if(isNaN(i)&&(i=util.zhStringToNumber(e[NUMBER_GROUP])),isNaN(i)){var d=e[NUMBER_GROUP];if("几"===d)i=3;else{if("半"!==d)return null;i=.5}}var u=moment(r),o=e[UNIT_GROUP],m=o[0];return m.match(/[日天星礼月年]/)?("日"==m||"天"==m?u.add(i,"d"):"星"==m||"礼"==m?u.add(7*i,"d"):"月"==m?u.add(i,"month"):"年"==m&&u.add(i,"year"),n.start.assign("year",u.year()),n.start.assign("month",u.month()+1),n.start.assign("day",u.date()),n):("秒"==m?u.add(i,"second"):"分"==m?u.add(i,"minute"):"小"==m&&u.add(i,"hour"),n.start.imply("year",u.year()),n.start.imply("month",u.month()+1),n.start.imply("day",u.date()),n.start.assign("hour",u.hour()),n.start.assign("minute",u.minute()),n.start.assign("second",u.second()),n.tags.ZHHansDeadlineFormatParser=!0,n)}};
},{"../../result":70,"../../utils/ZH-Hans.js":76,"../parser":55,"moment":2}],48:[function(require,module,exports){
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,ParsedComponents=require("../../result").ParsedComponents,util=require("../../utils/ZH-Hans.js"),patternString1="(?:由|从|自)?(?:(今|明|前|大前|后|大后|昨)(早|晚)|(上(?:午)|早(?:上)|下(?:午)|晚(?:上)|夜(?:晚)?|中(?:午)|凌(?:晨))|(今|明|前|大前|后|大后|昨)(?:日|天)(?:[\\s,，]*)(?:(上(?:午)|早(?:上)|下(?:午)|晚(?:上)|夜(?:晚)?|中(?:午)|凌(?:晨)))?)?(?:[\\s,，]*)(?:(\\d+|["+Object.keys(util.NUMBER).join("")+"]+)(?:\\s*)(?:点|时|:|：) (?:\\s*)(\\d+|半|正|整|["+Object.keys(util.NUMBER).join("")+"]+)?(?:\\s*)(?:分|:| ：)?(?:\\s*)(\\d+|["+Object.keys(util.NUMBER).join("")+"]+)?(?:\\s*)(?:秒)?)(?:\\s*(A.M.|P.M.|AM?|PM?))?",patternString2="(?:\\s*(?:到|至|\\-|\\–|\\~|\\〜)\\s*)(?:(今|明|前|大前|后|大后|昨)(早|晚)|(上(?:午)|早(?:上)|下(?:午)|晚(?:上)|夜(?:晚)?|中(?:午)|凌(?:晨))|(今|明|前|大前|后|大后|昨)(?:日|天)(?:[\\s,，]*)(?:(上(?:午)|早(?:上)|下(?:午)|晚(?:上)|夜(?:晚)?|中(?:午)|凌(?:晨)))?)?(?:[\\s,，]*)(?:(\\d+|["+Object.keys(util.NUMBER).join("")+"]+)(?:\\s*)(?:点|时|:|：) (?:\\s*)(\\d+|半|正|整|["+Object.keys(util.NUMBER).join("")+"]+)?(?:\\s*)(?:分|:| ：)?(?:\\s*)(\\d+|["+Object.keys(util.NUMBER).join("")+"]+)?(?:\\s*)(?:秒)?)(?:\\s*(A.M.|P.M.|AM?|PM?))?",FIRST_REG_PATTERN=new RegExp(patternString1,"i"),SECOND_REG_PATTERN=new RegExp(patternString2,"i"),DAY_GROUP_1=1,ZH_AM_PM_HOUR_GROUP_1=2,ZH_AM_PM_HOUR_GROUP_2=3,DAY_GROUP_3=4,ZH_AM_PM_HOUR_GROUP_3=5,HOUR_GROUP=6,MINUTE_GROUP=7,SECOND_GROUP=8,AM_PM_HOUR_GROUP=9;exports.Parser=function(){Parser.apply(this,arguments),this.pattern=function(){return FIRST_REG_PATTERN},this.extract=function(e,a,t,r){if(t.index>0&&e[t.index-1].match(/\w/))return null;var s=moment(a),i=new ParsedResult;i.ref=a,i.index=t.index,i.text=t[0],i.tags.ZHTimeExpressionParser=!0;var _=s.clone();if(t[DAY_GROUP_1]){var n=t[DAY_GROUP_1];"明"==n?s.hour()>1&&_.add(1,"day"):"昨"==n?_.add(-1,"day"):"前"==n?_.add(-2,"day"):"大前"==n?_.add(-3,"day"):"后"==n?_.add(2,"day"):"大后"==n&&_.add(3,"day"),i.start.assign("day",_.date()),i.start.assign("month",_.month()+1),i.start.assign("year",_.year())}else if(t[DAY_GROUP_3]){var d=t[DAY_GROUP_3];"明"==d?_.add(1,"day"):"昨"==d?_.add(-1,"day"):"前"==d?_.add(-2,"day"):"大前"==d?_.add(-3,"day"):"后"==d?_.add(2,"day"):"大后"==d&&_.add(3,"day"),i.start.assign("day",_.date()),i.start.assign("month",_.month()+1),i.start.assign("year",_.year())}else i.start.imply("day",_.date()),i.start.imply("month",_.month()+1),i.start.imply("year",_.year());var R=0,U=0,O=-1;if(t[SECOND_GROUP]){var P=parseInt(t[SECOND_GROUP]);if(isNaN(P)&&(P=util.zhStringToNumber(t[SECOND_GROUP])),P>=60)return null;i.start.assign("second",P)}if(R=parseInt(t[HOUR_GROUP]),isNaN(R)&&(R=util.zhStringToNumber(t[HOUR_GROUP])),t[MINUTE_GROUP]?"半"==t[MINUTE_GROUP]?U=30:"正"==t[MINUTE_GROUP]||"整"==t[MINUTE_GROUP]?U=0:(U=parseInt(t[MINUTE_GROUP]),isNaN(U)&&(U=util.zhStringToNumber(t[MINUTE_GROUP]))):R>100&&(U=R%100,R=parseInt(R/100)),U>=60)return null;if(R>24)return null;if(R>=12&&(O=1),t[AM_PM_HOUR_GROUP]){if(R>12)return null;var l=t[AM_PM_HOUR_GROUP][0].toLowerCase();"a"==l&&(O=0,12==R&&(R=0)),"p"==l&&(O=1,12!=R&&(R+=12))}else if(t[ZH_AM_PM_HOUR_GROUP_1]){var u=t[ZH_AM_PM_HOUR_GROUP_1],m=u[0];"早"==m?(O=0,12==R&&(R=0)):"晚"==m&&(O=1,12!=R&&(R+=12))}else if(t[ZH_AM_PM_HOUR_GROUP_2]){var M=t[ZH_AM_PM_HOUR_GROUP_2],y=M[0];"上"==y||"早"==y||"凌"==y?(O=0,12==R&&(R=0)):"下"!=y&&"晚"!=y||(O=1,12!=R&&(R+=12))}else if(t[ZH_AM_PM_HOUR_GROUP_3]){var G=t[ZH_AM_PM_HOUR_GROUP_3],o=G[0];"上"==o||"早"==o||"凌"==o?(O=0,12==R&&(R=0)):"下"!=o&&"晚"!=o||(O=1,12!=R&&(R+=12))}if(i.start.assign("hour",R),i.start.assign("minute",U),O>=0?i.start.assign("meridiem",O):R<12?i.start.imply("meridiem",0):i.start.imply("meridiem",1),!(t=SECOND_REG_PATTERN.exec(e.substring(i.index+i.text.length))))return i.text.match(/^\d+$/)?null:i;var N=_.clone();if(i.end=new ParsedComponents(null,null),t[DAY_GROUP_1]){var n=t[DAY_GROUP_1];"明"==n?s.hour()>1&&N.add(1,"day"):"昨"==n?N.add(-1,"day"):"前"==n?N.add(-2,"day"):"大前"==n?N.add(-3,"day"):"后"==n?N.add(2,"day"):"大后"==n&&N.add(3,"day"),i.end.assign("day",N.date()),i.end.assign("month",N.month()+1),i.end.assign("year",N.year())}else if(t[DAY_GROUP_3]){var d=t[DAY_GROUP_3];"明"==d?N.add(1,"day"):"昨"==d?N.add(-1,"day"):"前"==d?N.add(-2,"day"):"大前"==d?N.add(-3,"day"):"后"==d?N.add(2,"day"):"大后"==d&&N.add(3,"day"),i.end.assign("day",N.date()),i.end.assign("month",N.month()+1),i.end.assign("year",N.year())}else i.end.imply("day",N.date()),i.end.imply("month",N.month()+1),i.end.imply("year",N.year());if(R=0,U=0,O=-1,t[SECOND_GROUP]){var P=parseInt(t[SECOND_GROUP]);if(isNaN(P)&&(P=util.zhStringToNumber(t[SECOND_GROUP])),P>=60)return null;i.end.assign("second",P)}if(R=parseInt(t[HOUR_GROUP]),isNaN(R)&&(R=util.zhStringToNumber(t[HOUR_GROUP])),t[MINUTE_GROUP]?"半"==t[MINUTE_GROUP]?U=30:"正"==t[MINUTE_GROUP]||"整"==t[MINUTE_GROUP]?U=0:(U=parseInt(t[MINUTE_GROUP]),isNaN(U)&&(U=util.zhStringToNumber(t[MINUTE_GROUP]))):R>100&&(U=R%100,R=parseInt(R/100)),U>=60)return null;if(R>24)return null;if(R>=12&&(O=1),t[AM_PM_HOUR_GROUP]){if(R>12)return null;var l=t[AM_PM_HOUR_GROUP][0].toLowerCase();"a"==l&&(O=0,12==R&&(R=0)),"p"==l&&(O=1,12!=R&&(R+=12)),i.start.isCertain("meridiem")||(0==O?(i.start.imply("meridiem",0),12==i.start.get("hour")&&i.start.assign("hour",0)):(i.start.imply("meridiem",1),12!=i.start.get("hour")&&i.start.assign("hour",i.start.get("hour")+12)))}else if(t[ZH_AM_PM_HOUR_GROUP_1]){var u=t[ZH_AM_PM_HOUR_GROUP_1],m=u[0];"早"==m?(O=0,12==R&&(R=0)):"晚"==m&&(O=1,12!=R&&(R+=12))}else if(t[ZH_AM_PM_HOUR_GROUP_2]){var M=t[ZH_AM_PM_HOUR_GROUP_2],y=M[0];"上"==y||"早"==y||"凌"==y?(O=0,12==R&&(R=0)):"下"!=y&&"晚"!=y||(O=1,12!=R&&(R+=12))}else if(t[ZH_AM_PM_HOUR_GROUP_3]){var G=t[ZH_AM_PM_HOUR_GROUP_3],o=G[0];"上"==o||"早"==o||"凌"==o?(O=0,12==R&&(R=0)):"下"!=o&&"晚"!=o||(O=1,12!=R&&(R+=12))}if(i.text=i.text+t[0],i.end.assign("hour",R),i.end.assign("minute",U),O>=0)i.end.assign("meridiem",O);else{i.start.isCertain("meridiem")&&1==i.start.get("meridiem")&&i.start.get("hour")>R?i.end.imply("meridiem",0):R>12&&i.end.imply("meridiem",1)}return i.end.date().getTime()<i.start.date().getTime()&&i.end.imply("day",i.end.get("day")+1),i}};
},{"../../result":70,"../../utils/ZH-Hans.js":76,"../parser":55,"moment":2}],49:[function(require,module,exports){
var moment=require("moment"),Parser=require("../parser").Parser,ParsedResult=require("../../result").ParsedResult,updateParsedComponent=require("../EN/ENWeekdayParser").updateParsedComponent,util=require("../../utils/ZH-Hans.js"),PATTERN=new RegExp("(上|下|这)?(?:个)?(?:星期|礼拜|周)("+Object.keys(util.WEEKDAY_OFFSET).join("|")+")"),PREFIX_GROUP=1,WEEKDAY_GROUP=2;exports.Parser=function(){Parser.apply(this,arguments),this.pattern=function(){return PATTERN},this.extract=function(e,r,t,a){var s=t.index;e=t[0];var n=new ParsedResult({index:s,text:e,ref:r}),u=t[WEEKDAY_GROUP],i=util.WEEKDAY_OFFSET[u];if(void 0===i)return null;var P=null,E=t[PREFIX_GROUP];return"上"==E?P="last":"下"==E?P="next":"这"==E&&(P="this"),updateParsedComponent(n,r,i,P),n.tags.ZHHansWeekdayParser=!0,n}};
...
var NUMBER={"零":0,"一":1,"二":2,"两":2,"三":3,"四":4,"五":5,"六":6,"七":7,"八":8,"九":9,"十":10,"廿":20,"卅":30},WEEKDAY_OFFSET={"天":0,"日":0,"一":1,"二":2,"三":3,"四":4,"五":5,"六":6};exports.NUMBER=NUMBER,exports.WEEKDAY_OFFSET=WEEKDAY_OFFSET,exports.zhStringToNumber=function(r){for(var E=0,t=0;t<r.length;t++){var e=r[t];"十"===e?E=0===E?NUMBER[e]:E*NUMBER[e]:E+=NUMBER[e]}return E},exports.zhStringToYear=function(r){for(var E="",t=0;t<r.length;t++){var e=r[t];E+=NUMBER[e]}return parseInt(E)};
